...
pub struct SettingsStyle {
    ...
    /// Node label font size multiplier (0.5 = half, 2.0 = double).
    pub node_label_size: f32,
    /// Edge label font size multiplier (0.5 = half, 2.0 = double).
    pub edge_label_size: f32,
...
impl Default for SettingsStyle {
    fn default() -> Self {
        Self {
            ...
            show_edge_labels: false, // Off by default - edges typically don't have meaningful labels
            node_label_size: 1.0,
            edge_label_size: 1.0,
